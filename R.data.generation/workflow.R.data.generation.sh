...
# HMM models for the essential proteins: essential.hmm
...
perl multi-metagenome/misc.scripts/calc.kmerfreq.pl -i assembly.fa -o assembly.kmer.tab

echo ""
echo "Calculating gc content"
perl multi-metagenome/misc.scripts/calc.gc.pl -i assembly.fa -o assembly.gc.tab
...
hmmsearch --tblout assembly.hmm.orfs.txt --cut_tc --notextw essential.hmm assembly.orfs.faa > hmm.temp.txt
...
perl multi-metagenome/misc.scripts/extract.using.header.list.pl -l list.of.positive.orfs.txt -s assembly.orfs.faa -o assembly.orfs.hmm.faa
...
perl multi-metagenome/misc.scripts/hmm.majority.vote.pl -i assembly.orfs.hmm.blast.tax.txt -o assembly.tax.consensus.txt -n
